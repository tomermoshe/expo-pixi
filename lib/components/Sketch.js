...
export default class Sketch extends React.Component<Props> {
  ...
  setupPanResponder = () => {
    const onEnd = event => {
      const locationY = event.pageY - this.locationPageOffsetY;
      const locationX = event.pageX - this.locationPageOffsetX;
      this.drawLine(scaled({ locationX, locationY }), false);
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderGrant: ({ nativeEvent }) => {
        ...
        this.locationPageOffsetY = nativeEvent.pageY - nativeEvent.locationY;
        this.locationPageOffsetX = nativeEvent.pageX - nativeEvent.locationX;
      },
      onPanResponderMove: ({ nativeEvent }) => {
        const locationY = nativeEvent.pageY - this.locationPageOffsetY;
        const locationX = nativeEvent.pageX - this.locationPageOffsetX;
        const point = scaled({ locationX, locationY });
